...
function DataTable<T extends object>({
  ...
  // Dropdown state cho từng cột searchAndSelect
    ...
    <div className="flex justify-center w-full">
      <div className="bg-white rounded shadow p-4">
        <div className="w-full overflow-x-auto">
          <table className="border text-sm" style={{ width: "max-content", minWidth: 800 }}>
            <thead>
              <tr>
                {columns.map((col) => (
                  <th
                ...
                <tr key={row.id || idx}>
                  {columns.map((col, colIdx) => (
                    <td
                      ...
                      style={{
                        whiteSpace: col.key === "partners" ? "pre-line" : "normal",
                      }}
                    >
                      {col.render
